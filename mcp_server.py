...
mcp = FastMCP(
    ...
    description="提供天气、时间、知识库搜索、网络搜索和代码执行功能",
    version="1.0.0"
)
# ==================== 天气工具 ====================
@mcp.tool(
...
def search_knowledgebase(kb_name: str, query: str, ctx: Context) -> str:    #ctx 是 MCP (Model Context Protocol) 框架自动注入的上下文对象，包含了当前请求的上下文信息
    """
    知识库搜索
    ...
    Returns:
        检索结果
    """
    ctx.info(f"正在知识库 '{kb_name}' 中搜索: {query}")
